document.addEventListener("DOMContentLoaded", function () {
    ...
    hover2.addEventListener("mouseover", () => {
        ...
        bottomPart.classList.replace("from-[rgba(255,255,255,0.8)]", "from-primary");
    ...
    hover2.addEventListener("mouseout", () => {
        ...
        bottomPart.classList.replace("from-primary", "from-[rgba(255,255,255,0.8)]");
    ...
    createPieChart("pieChart1", [7, 93], ["#0047BB", "#FFFFFF"], ["#0047BB", "transparent"]);
    createPieChart("pieChart2", [7, 93], ["#0093B2", "#FFFFFF"], ["#0093B2", "transparent"]);
    createPieChart("pieChart3", [7, 93], ["#3E89DD", "#FFFFFF"], ["#3E89DD", "transparent"]);
});
